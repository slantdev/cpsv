...
<!-- Hero -->
<section class="section-hero relative -mt-[136px] bg-cover bg-center" style="background-image: url(<?php echo cpsv_asset('images/banner/catbanner-01.jpg') ?>);">
  <div class="bg-brand-light-gray bg-opacity-80 pt-44">
    <div class="container max-w-screen-2xl">
      <div class="flex py-16 items-end">
        <div class="w-1/2">
  ...
  <div class="bg-brand-blue bg-opacity-80 py-16">
      ...
      <div class="grid grid-cols-4 divide-x divide-white/70">
        <div class="text-white px-12">
          <div class="flex gap-x-6 items-center mb-4">
            <div class="flex-none"><?php echo cpsv_icon(array('icon' => 'line-cat-face', 'group' => 'content', 'size' => '96', 'class' => 'w-[5.5rem] h-[5.5rem] text-white')); ?></div>
            <div class="font-semibold text-[44px] leading-tight">180</div>
          </div>
          <div class="text-2xl leading-tight">Abandoned & lost Cats in our care at CPSV</div>
        </div>
        <div class="text-white px-12">
          <div class="flex gap-x-6 items-center mb-4">
            <div class="flex-none"><?php echo cpsv_icon(array('icon' => 'line-cat-home', 'group' => 'content', 'size' => '96', 'class' => 'w-[5.5rem] h-[5.5rem] text-white')); ?></div>
            <div class="font-semibold text-[44px] leading-tight">1,354</div>
          </div>
          <div class="text-2xl leading-tight">Cats reunited & rehomed from our Adoption Shelter</div>
        </div>
        <div class="text-white px-12">
          <div class="flex gap-x-6 items-center mb-4">
            <div class="flex-none"><?php echo cpsv_icon(array('icon' => 'line-cat-love', 'group' => 'content', 'size' => '96', 'class' => 'w-[5.5rem] h-[5.5rem] text-white')); ?></div>
            <div class="font-semibold text-[44px] leading-tight">200</div>
          </div>
          <div class="text-2xl leading-tight">Cats who have spent time in our Foster Program</div>
        </div>
        <div class="text-white px-12">
          <div class="flex gap-x-6 items-center mb-4">
            <div class="flex-none"><?php echo cpsv_icon(array('icon' => 'line-cat-hand', 'group' => 'content', 'size' => '96', 'class' => 'w-[5.5rem] h-[5.5rem] text-white')); ?></div>
            <div class="font-semibold text-[44px] leading-tight">4,354</div>
          </div>
          <div class="text-2xl leading-tight">Cats who have been desexed at our Vet Clinic</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="relative pt-12 lg:pt-20 xl:pt-36 pb-12 lg:pb-20 xl:pb-36">
    <div class="container mx-auto max-w-screen-2xl">
      ...
      <div class="relative z-10 flex flex-col xl:flex-row xl:gap-x-12 2xl:gap-x-24">
        <div class="xl:w-1/2">
          <h3 class="text-brand-dark-blue font-semibold text-[32px] leading-tight">For over 70 years, the Cat Protection Society of Victoria has been dedicated to ensuring every cat finds a loving, safe, and healthy home through community collaboration.</h3>
        </div>
        <div class="xl:w-1/2">
          <div class="prose xl:prose-lg font-medium max-w-none">
            <p>As a not for profit, our society relies entirely on the kindness of donations, legacies and memberships for our day-to-day existence and to ensure we can provide the highest levels of care to cats in need. We receive no government funding.</p>
            <p>Located at 200 Elder Street, Greensborough Victoria, The Cat Protection Society includes an Adoption Shelter, Veterinary Clinic and Retail Store.</p>
            <p>To view our cats that are currently available for adoption and hoping to find their forever home, click here</p>
          </div>
          <div class="mt-8">
            <a href="#" class="btn btn-primary btn-outline rounded-full border-brand-dark-blue text-xl leading-tight px-10 h-auto">Adopt a cat</a>
          </div>
        </div>
      </div>
    </div>
